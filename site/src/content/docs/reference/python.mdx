...
This page documents the Python package. For Node, Bun, Ruby, Go, and Elixir,
see [SQLite bindings](/reference/sqlite-bindings/).
...
`run_retention(...)` registers recurring work through Honker Scheduler, and each
