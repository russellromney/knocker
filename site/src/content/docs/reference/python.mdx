...
description: Install and use Knocker from Python.
---

The Python binding exposes Knocker's shared SQLite extension contract with
Python idioms for endpoints, handlers, operators, and retention.
