...
Keeping this glue in docs also keeps Knocker's package small: no FastAPI, Flask, Django, Starlette, or ASGI dependency choices leak into the durable webhook core.

The route glue is small:
